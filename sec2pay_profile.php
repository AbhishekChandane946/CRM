...
<html lang="en">
  ...
  <body >
             ...
             <div class="card">
                <div class="card-body">
                    <div class="profile-header">
                        <img src="./dist/img/profiles/ac.jpg" alt="Profile Picture" class="profile-img">
                        <div class="profile-info">
                          <h3>Abhishek Chandane</h3>
                          <p>abhishek.chandane@sec2payindia.com</p>
                        </div>
                   </div>
                   ...
                   <div class="profile-form">
                     <div class="form-group">
                       ...
                       <div class="d-flex gap-3">
                         <input type="text" id="firstName" class="form-control" placeholder="First Name" value="Abhishek">
                         <input type="text" id="lastName" class="form-control" placeholder="Last Name" value="Chandane">
                       </div>
                     </div>
                     <div class="form-group mt-3">
                       <label for="email">Email address</label>
                       <input type="email" id="email" class="form-control" value="abhishek.chandane@sec2payindia.com">
                     </div>
                     <div class="form-group mt-3">
                       <label for="empId">Employee ID</label>
                       <div class="input-group">
                         <span class="input-group-text"><img width="100"  src="./dist/img/logo/sec2pay.svg" alt=""> - </span>
                         <input type="text" id="empId" class="form-control" value="000111222">
                       </div>
                     </div>
                     <div class="form-group mt-3">
                       <label>Profile photo</label>
                       <div class="profile-photo">
                         <img src="./dist/img/profiles/ac.jpg" alt="Profile Photo">
                         <button class="btn btn-outline-secondary">Click to replace</button>
                       </div>
                     </div>
                   </div>
                  ...
                  <div class="card-footer d-flex justify-content-between p-5">
                        <button class="button_delete" style="border-radius: 25px;">
                          <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-trash"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 7l16 0" /><path d="M10 11l0 6" /><path d="M14 11l0 6" /><path d="M5 7l1 12a2 2 0 0 0 2 2h8a2 2 0 0 0 2 -2l1 -12" /><path d="M9 7v-3a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v3" /></svg>
                          Delete User
                        </button> 
                        <button class="button" style="border-radius: 25px; width: 150px;">
    ...
    <script>
        // SweetAlert for Delete User button
        ...
        // SweetAlert for Save Changes button
