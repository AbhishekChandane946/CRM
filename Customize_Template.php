                          ...
                          <div id="company-details" class="d-none">
                              <div class="row">
                                  <div class="col-md-6">
                                      ...
                                      <input type="text" id="company-logo-input" class="form-control mb-2" placeholder="Enter Logo URL" required>
                                  </div>
                                  <div class="col-md-6">
    ...
    <script>
      $(document).ready(function () {
            ...
            if (selectedTemplate) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        let twitterLink = $("#twitter-link-input").val();
                        let linkedinLink = $("#linkedin-link-input").val();
                        ...
                        twitterLink = twitterLink.trim() || "https://default-twitter.com";
                        linkedinLink = linkedinLink.trim() || "https://default-linkedin.com";
        ...
        $("input[name='template']").on("change", function () {
            ...
            if (selectedValue === "payment/source.html" || selectedValue === "message/source.html" || selectedValue === "valentines-1/source.html") {
        ...
        $("#send-mail").on("click", function () {
            ...
            if (selectedTemplate === "payment/source.html" || selectedTemplate === "message/source.html" || selectedTemplate === "valentines-1/source.html") {
                formData.companyLogo = $("#company-logo-input").val();
                formData.bannerImage = $("#banner-image-input").val();
                formData.facebookLink = $("#facebook-link-input").val();
                formData.twitterLink = $("#twitter-link-input").val();
                formData.linkedinLink = $("#linkedin-link-input").val();
                formData.instagramLink = $("#instagram-link-input").val();
            }
